...
import com.google.android.exoplayer2VRT.text.TextRenderer;
...
import com.google.android.exoplayer2VRT.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.exoplayer2VRT.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
              com.google.android.exoplayer2VRT.video.VideoRendererEventListener.class,
              int.class);
  ...
  protected void buildAudioRenderers(
    ...
    try {
      ...
      Class<?> clazz = Class.forName(
          "com.google.android.exoplayer2VRT.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer2VRT.audio.AudioRendererEventListener.class,
              com.google.android.exoplayer2VRT.audio.AudioProcessor[].class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName(
          "com.google.android.exoplayer2VRT.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer2VRT.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.google.android.exoplayer2VRT.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer2VRT.audio.AudioRendererEventListener.class,
