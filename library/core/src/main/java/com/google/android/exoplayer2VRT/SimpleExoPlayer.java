...
import com.google.android.exoplayer2VRT.analytics.AnalyticsCollector;
import com.google.android.exoplayer2VRT.analytics.AnalyticsListener;
import com.google.android.exoplayer2VRT.audio.AudioAttributes;
import com.google.android.exoplayer2VRT.audio.AudioFocusManager;
import com.google.android.exoplayer2VRT.audio.AudioListener;
import com.google.android.exoplayer2VRT.audio.AudioRendererEventListener;
import com.google.android.exoplayer2VRT.audio.AuxEffectInfo;
import com.google.android.exoplayer2VRT.decoder.DecoderCounters;
import com.google.android.exoplayer2VRT.drm.DefaultDrmSessionManager;
...
import com.google.android.exoplayer2VRT.trackselection.TrackSelectionArray;
...
import com.google.android.exoplayer2VRT.video.VideoFrameMetadataListener;
import com.google.android.exoplayer2VRT.video.VideoRendererEventListener;
import com.google.android.exoplayer2VRT.video.spherical.CameraMotionListener;
...
public class SimpleExoPlayer extends BasePlayer
  ...
  /** @deprecated Use {@link com.google.android.exoplayer2VRT.video.VideoListener}. */
  @Deprecated
  public interface VideoListener extends com.google.android.exoplayer2VRT.video.VideoListener {}
  ...
  private final CopyOnWriteArraySet<com.google.android.exoplayer2VRT.video.VideoListener>
      videoListeners;
  ...
  @Override
  public void addVideoListener(com.google.android.exoplayer2VRT.video.VideoListener listener) {
    videoListeners.add(listener);
  }

  @Override
  public void removeVideoListener(com.google.android.exoplayer2VRT.video.VideoListener listener) {
   ...
   * @deprecated Use {@link #addVideoListener(com.google.android.exoplayer2VRT.video.VideoListener)}.
   */
  @Deprecated
  ...
  /**
   * Equivalent to {@link #removeVideoListener(com.google.android.exoplayer2VRT.video.VideoListener)}.
   *
   * @param listener The listener to clear.
   * @deprecated Use {@link
   *     #removeVideoListener(com.google.android.exoplayer2VRT.video.VideoListener)}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  ...
  private void maybeNotifySurfaceSizeChanged(int width, int height) {
    if (width != surfaceWidth || height != surfaceHeight) {
      ...
      for (com.google.android.exoplayer2VRT.video.VideoListener videoListener : videoListeners) {
